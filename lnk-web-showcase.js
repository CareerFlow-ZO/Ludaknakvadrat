(() => {
  ...
  const designs = [
    ...
    {id:'basic-warm',tier:'basic',name:'Warm Local',price:'599.99€',theme:'warm',pkg:'BASIC — 599.99€',desc:{sr:'Topliji stil za restoran, salon, apartman, lokalni biznis ili uslužnu djelatnost.',sl:'Topel stil za restavracijo, salon, apartma ali lokalno dejavnost.',en:'Warm style for restaurants, salons, stays and local service businesses.',de:'Warmer Stil für Gastronomie, Salon, Unterkunft und lokale Services.'},tags:['Local','Friendly','Booking']},
