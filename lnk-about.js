(() => {
  ...
  function addStyles(){
    ...
    s.textContent=`
      ...
      .about-details{display:grid;gap:10px}.about-row{display:grid;grid-template-columns:145px 1fr;gap:14px;padding:12px 0;border-bottom:1px solid rgba(70,184,255,.10)}.about-row:last-child{border-bottom:0}.about-row span{color:#6f8ca2;font-size:12px;font-weight:800;text-transform:uppercase;letter-spacing:.07em}.about-row b{color:#eaf7ff;font-size:14px;line-height:1.5;word-break:break-word}
