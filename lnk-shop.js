(() => {
  ...
  const COPY={
    sr:{
      ...
      demo:'Live demo',buy:'Naruči',custom:'Prilagodi',popular:'POPULARNO',
    ...
    sl:{
      ...
      demo:'Live demo',buy:'Naroči',custom:'Prilagodi',popular:'POPULARNO',
    ...
    en:{
      ...
      demo:'Live demo',buy:'Order',custom:'Customize',popular:'POPULAR',
    ...
    de:{
      ...
      demo:'Live Demo',buy:'Bestellen',custom:'Anpassen',popular:'BELIEBT',
  ...
  const webProducts=[
    {icon:'✂️',name:'Barbershop Website',desc:'Moderan premium template za barber shop i booking.',price:'49,99 €',demo:'https://lnk-barber-demo.vercel.app'},
    {icon:'✨',name:'Beauty Salon Website',desc:'Elegantni template za salon ljepote i usluge.',price:'49,99 €'},
    {icon:'🚘',name:'Auto Service Website',desc:'Profesionalni template za auto servis i mehaničare.',price:'59,99 €',demo:'https://avtolux-preview.vercel.app'},
    {icon:'🍽️',name:'Restaurant Website',desc:'Moderan template za restoran, meni i rezervacije.',price:'59,99 €'},
    {icon:'💼',name:'Premium Business Website',desc:'Univerzalni premium poslovni template.',price:'79,99 €',demo:'https://rocna-stil-preview.vercel.app'}
  ];
  const musicProducts=[
    {icon:'✍️',name:'Personalizovani tekst pjesme',desc:'Originalan tekst prema tvojoj priči.',price:'19,99 €'},
    {icon:'🖼️',name:'Cover za pjesmu',desc:'16:9 + 9:16 vizual za YouTube i TikTok.',price:'14,99 €'},
    {icon:'🎬',name:'Lyric video',desc:'Video sa tekstom spreman za objavu.',price:'29,99 €'},
    {icon:'🎵',name:'Personalizovana pjesma + cover',desc:'Pjesma i kompletan cover paket.',price:'49,99 €'},
    {icon:'💿',name:'Pjesma + cover + lyric video',desc:'Kompletan paket spreman za objavu.',price:'79,99 €'},
    {icon:'❤️',name:'Digital Love Gift',desc:'Personalizovana pjesma + cover + QR poklon.',price:'39,99 €',featured:true}
  ];
  const socialProducts=[
    {icon:'🛍️',name:'Starter Pack',desc:'10 Instagram/TikTok dizajnova spremnih za objavu.',price:'19,99 €'},
    {icon:'👑',name:'Business Pack',desc:'Logo + profilna + 20 objava + story dizajni.',price:'39,99 €'},
    {icon:'💎',name:'Premium Branding Pack',desc:'Logo + cover + social kit + vizuelni identitet.',price:'69,99 €'}
  ];
  ...
  function card(p,kind){
    const c=t(), actions=[];
    if(p.demo) actions.push('<a class="ls-btn" href="'+p.demo+'" target="_blank" rel="noopener">'+c.demo+'</a>');
    ...
    return '<article class="ls-card'+(p.featured?' featured':'')+'">'+(p.featured?'<span class="ls-popular">'+c.popular+'</span>':'')+
      '<div class="ls-card-top"><span class="ls-card-icon">'+p.icon+'</span>'+(p.demo?'<span class="ls-preview-badge">'+c.demo+'</span>':'')+'</div>'+
      '<h4>'+p.name+'</h4><p>'+p.desc+'</p><div class="ls-price">'+p.price+'</div>'+
      '<div class="ls-actions '+(actions.length>1?'two':'')+'">'+actions.join('')+'</div></article>';
  }
